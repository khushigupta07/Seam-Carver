...
public:
  ...
  // removes horizontal seam in image
  void RemoveHorizontalImageSeam(int* seam_row_values);

  // removes vertical seam in image
  void RemoveVerticalImageSeam(int* seam_col_values);
